        ...
        <div class="dashboard-container-facility-manger">
            ...
            <div class="dashboard-container-facility-row-2">
                <div class="dashboard-container-facility-tiles">
                    <div class="tasks">
                    <img src="<?php echo URL_ROOT . '/resources/facility/completed-task.svg' ?>" class="completed-task-icon">
                ...
                <div class="dashboard-container-facility-tiles">
                    <div class="tasks">
                    <img src="<?php echo URL_ROOT . '/resources/facility/ongoing-task.svg' ?>" class="ongoing-task-icon">
                ...
                <div class="dashboard-container-facility-tiles">
                    <div class="tasks">
                    <img src="<?php echo URL_ROOT . '/resources/facility/population.png' ?>" class="total-task-icon">
