    ...
    <div class="main-container-sign-in">
      <div class="sign-in-container">
        <div class="sign-in-image-container">
         <img src="<?php echo URL_ROOT . 'resources/Computer login-bro.svg'?>" class="sign-in-container-company-logo">
        </div>
        <div class="sign-in-form-container">
          <div class="login-form">
            <div class="company-profile">
               <img src="<?php echo URL_ROOT . 'resources/company-logo-small.png'?>" class="logo-sign-in">
