        ...
        <div class="technician-dashboard-container">
            ...
            <div class="tech-dashboard-row-2">
                <div class="tech-total-task-tile">
                    <div class="tasks">
                        <img src="<?php echo URL_ROOT . '/resources/finances/total-task.svg' ?>" class="total-task-icon">
                    </div>
                ...
                <div class="tech-ongoing-task-tile">
                    <div class="tasks">
                        <img src="<?php echo URL_ROOT . '/resources/finances/ongoing-task.svg' ?>" class="ongoing-task-icon">
                ...
                <div class="tech-completed-task-tile">
                    <div class="tasks">
                    <img src="<?php echo URL_ROOT . '/resources/finances/completed-task.svg' ?>" class="completed-task-icon">
