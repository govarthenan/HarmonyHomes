...
<html lang="en">
  ...
  <body onload="randerDate()">
    <div class="main-content">
      <div class="booking-container-fitness-center">
        <div class="appointment-heading-container">
          <img src="<?php echo URL_ROOT . '/resources/resident_dashboard/appoinment_img.svg'?>" class="appoinment-image">
          <span class="appointment-heading">Book Your Slot</span>
        </div>
        <hr>
        <div class="form-date-fitness-center">
              <div class="form-date-heading">
                  <span class="date-of-slot">Select date</span>
                  <img src="<?php echo URL_ROOT . '/resources/resident_dashboard/arrow-right.svg'?>">
              </div>
              <div class="date">
                <img src="<?php echo URL_ROOT . '/resources/resident_dashboard/chevron-left.svg'?>" class="date-name-arrow">
                ...
                <img src="<?php echo URL_ROOT . '/resources/resident_dashboard/chevron-right.svg'?>" class="date-name-arrow">
              </div>
      </div>
      
      <div class="form-time-fitness-center">
              <div class="form-date-heading">
