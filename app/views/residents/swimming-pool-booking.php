    ...
    <div class="main-content">
      <div class="booking-container-fitness-center">
        ...
        <div class="form-date-fitness-center">
              ...
              <div class="date">
              <img src="<?php echo URL_ROOT . 'resources/amenity/chevron-left.svg'?>" class="date-name-arrow">
                ...
                <img src="<?php echo URL_ROOT . 'resources/amenity/chevron-right.svg'?>" class="date-name-arrow">
              </div>
        </div>
