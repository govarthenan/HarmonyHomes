    ...
    <div class="main-content">
      <div class="booking-container-common-area">
        ...
        <div class="form-date-common-area">
              ...
              <div class="date">
                <img src="<?php echo URL_ROOT . '/resources/resident_dashboard/chevron-left.svg'?>" class="date-name-arrow" onclick="prevWeek()">
                ...
                <img src="<?php echo URL_ROOT . '/resources/resident_dashboard/chevron-right.svg'?>" class="date-name-arrow" onclick="nextWeek()">
              </div>
        </div>
